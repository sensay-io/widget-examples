export const PRODUCTS = [
    ...
    },
    {
      ...
      description: "Anthropic's most capable AI model for complex reasoning and analysis",
      category: "Language Model",
    ...
    },
    {
      id: 3,
      name: "DALL-E 3",
      description: "State-of-the-art image generation model with enhanced creativity",
      category: "Image Generation",
      content: "DALL-E 3 revolutionizes image creation with its ability to generate highly detailed and creative visuals from text descriptions. The model understands complex prompts and can create images in various artistic styles, from photorealistic to abstract art. It features improved safety measures and better adherence to user prompts, making it an invaluable tool for artists, designers, and content creators.",
      features: {
    ...
    },
    {
      id: 9,
      name: "CodeT5",
      description: "Specialized AI model for code generation and programming assistance",
